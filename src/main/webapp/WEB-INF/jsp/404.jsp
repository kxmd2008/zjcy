		...
		<div id="body-container">
			...
			<div id="right-column">
				<div class="right-column-content">
					<div class="row">
						<div class="col-md-12">
							<div class="page-not-found highlight-color-yellow">
								<div class="not-found-icons highlight-color-yellow-icon">
									<span class="icon icon-number-four icon-size-large"></span>
								...
								<div class="not-found-description">
									<p class="text-center">The page you are looking for doesn't seem to exist anymore, or maybe it never did.</p>
									<p class="text-center">You can, <a href="index.html">Return to the dashboard</a>, or try searching for what you want instead.</p>
								</div>
							</div>
						</div>
					</div>
